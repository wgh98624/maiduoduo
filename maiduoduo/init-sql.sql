...
INSERT INTO `user_address` (`id`, `userId`, `province`, `city`, `area`, `address`, `name`, `phone`, `type`, `createdAt`, `updatedAt`, `version`) VALUES (UUID(), 'halloffame', '广东省', '深圳市', '宝安区', '电商产业园105号', '伍常', '15302638062', 1, now(), now(), 0);
